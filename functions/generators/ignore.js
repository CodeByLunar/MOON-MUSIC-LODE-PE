...
module.exports = async (client, message, emoji, ignored, menu = false) => {
  ...
  let embed = new client.embed()
    ...
    .thumb(`https://cdn.discordapp.com/attachments/1287023669738213440/1292511725513478196/standard_1.gif?ex=67643e59&is=6762ecd9&hm=90b64acf28764394830ee50c1336ed757e274e06507c7a8d9c17f92189e5b4eb&`)
    .setFooter({
      text: `Developed by Pookie HQㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,
    });
