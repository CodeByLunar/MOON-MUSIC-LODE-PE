...
module.exports = class ExtendedClient extends Client {
  constructor() {
    ...
    this.db = {
      ...
      cmdCount: require("@db/cmdCount.js"),
      songStats: require("@db/songStats.js"),
      vcact: require("@db/Voicetime.js"),
      ...
      premiumLogs: require("@db/premiumLogs.js"),
    };
  ...
  log = (message, type = "log") => {
    ...
    async ConnectMongo() {
    try {
      await mongoose.connect('mongodb+srv://Pookie:Pookie@funny.huc3om6.mongodb.net/?retryWrites=true&w=majority&appName=funny', {
        useNewUrlParser: true,
        useUnifiedTopology: true,
      });
      this.log("Connected to MongoDB!", "ready");
    } catch (error) {
      this.log(`MongoDB connection error: ${error}`, "error");
        }
   }
