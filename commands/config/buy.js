      ...
      .addOptions([
        {
          ...
          value: "7_300",
          emoji: `<a:RED_DIAMOND:1292531280562487389>`,
        },
        {
    ...
    const m = await message
      .reply({
        embeds: [
          new client.embed()
            .desc(
              `<:black_moeda_:1277897366195666966> **You have a total of ${coins || `0`} coins\n\n` +
                `<:Pookie_music:1292516927658524673> Ready to Upgrade? Purchase Premium Now! <:black_moeda_:1277897366195666966>
...
<a:RED_DIAMOND:1292531280562487389> Your premium music journey awaits <a:RED_DIAMOND:1292531280562487389>**`,
            )

            .setFooter({
              text: `developed by team Pookie ㅤㅤ`,
            }),
        ],
        components: rows,
      })
